...
## getaccount
Метод возвращает информацию об аккаунте.
Параметры метода: 
- **author** - чей аккакунт исследуем

## getaccountkeys
Метод возвращает открытые ключи симметричного шифрования аккаунта.
Параметры метода: 
- **author** - чей аккакунт исследуем

## getwitnesses
Метод возвращает данные по текущим активным нодам

## getreblogs
Метод возвращает информацию о реблогах указанного поста.
Параметры метода: 
- **permlink** - идентификатор записи
- **author** - ник автора поста
